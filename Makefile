...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.jAtCoR>
...
# operating system:  Linux 2.6.22-14-generic i686 [ELF] (2.6.22)
# libc:	(6.6.1)
# binutils:	(218)
...
SRCS    := Neuron.cpp GenericLayer.cpp NeuralNet.cpp GuessCaptcha.cpp guess.cpp
OBJS    := $(SRCS:.cpp=.o)
...
.cpp.o:
	$(CC) $(CCOPTIONS) $(CXXSTD_DEFINES) -c $< $(INCLUDES)
...
guess: $(OBJS)
	$(RM) $@
	$(CCLINK) -o $@ $(LDOPTIONS) $(OBJS) $(LIBDIRS) $(LDLIBS) $(LIBS) $(EXTRA_LOAD_FLAGS)
